    ...
    <div class="flex flex-col justify-center items-center h-full px-5 md:px-0">
        <section class="bg-white mx-5 w-full md:mx-0 md:w-[500px] mt-10 shadow-md py-5 px-8 rounded-xl">
            ...
            <div class="flex flex-col justify-center">
                <h2 class="text-center font-black text-4xl my-8">Log in</h2>
            ...
            <p class="text-center text-lg text-gray-600 font-bold mt-10">Or, log in with email</p>
            <form class="text-gray-600 mt-5" action="{{ route('login') }}" method="POST">
                @csrf
                ...
                @error('email')
                    <div class="bg-red-500 text-white text-center p-3 mb-5">
                        {{ $message }}
                    </div>
                @enderror
                ...
                <div class="mb-5">
                    <button class="btn w-full text-xl rounded-xl hover:bg-indigo-700 px-6">Log in</button>
                </div>
        ...
        <div class="mt-10 text-sm text-gray-400 text-center">
            ...
            No account? <a href="{{ route('login') }}" class="text-indigo-500 hover:text-gray-700">Sign up instead</a>
        </div>
    </div>
@endsection
